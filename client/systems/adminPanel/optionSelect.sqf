			...
			switch (lbCurSel _adminSelect) do
			{
				...
				case 4: //Teleport
				{
					...
					["A3W_teleport", "onMapSingleClick",
					{
						...
						if (isNil "_waterPos") then {_pos set [2, ((getposASL player) select 2)]; vehicle player setPosASL _pos } else { vehicle player setPosASL _waterPos };
