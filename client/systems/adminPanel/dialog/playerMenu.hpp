...
class PlayersMenu
{
	...
	class controlsBackground {
		...
		class PlayerBasebuildernText : w_RscText
		{
			idc = playerMenuBasebuilder;
			text = "BasebuilderPoints:";
			sizeEx = 0.030;
			x = 0.52 * (4 / 3) * SZ_SCALE_ABS + safezoneX;
			y = 0.355 * SZ_SCALE_ABS + safezoneY;
			w = 0.25 * (4 / 3) * SZ_SCALE_ABS;
			h = 0.04 * SZ_SCALE_ABS;
		};
		class PlayerBountypointsText : w_RscText
		{
			idc = playerMenuBountypoints;
			text = "Bountypoints:";
			sizeEx = 0.030;
			x = 0.52 * (4 / 3) * SZ_SCALE_ABS + safezoneX;
			y = 0.375 * SZ_SCALE_ABS + safezoneY;
			w = 0.25 * (4 / 3) * SZ_SCALE_ABS;
			h = 0.04 * SZ_SCALE_ABS;
		};
		class PlayerAnimalpointsText : w_RscText
		{
			idc = playerMenuAnimalpoints;
			text = "Animalpoints:";
			sizeEx = 0.030;
			x = 0.52 * (4 / 3) * SZ_SCALE_ABS + safezoneX;
			y = 0.395 * SZ_SCALE_ABS + safezoneY;
			w = 0.25 * (4 / 3) * SZ_SCALE_ABS;
			h = 0.04 * SZ_SCALE_ABS;
		};
	};
