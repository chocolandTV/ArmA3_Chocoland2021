...
#define idc_objectSearchDeleteButton 55606
#define GUI_GRID_X	(0)
#define GUI_GRID_Y	(0)
...
class ObjectSearch
{
	...
	class Controls
	{
		...
		class ObjectSearchDeleteButton: tw_RscButton
		{
			idc = objectSearchDeleteButton;
			text = "delete";
			onButtonClick = "[3] execVM 'client\systems\adminPanel\objectSearchInteraction.sqf'";
