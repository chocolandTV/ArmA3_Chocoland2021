...
//choco function to server
class Choco_fnc_dropSupply { allowedTargets = 2; };
...
class Choco_fnc_takeNuclearStrike { allowedTargets = 2; };
class Choco_fnc_becomeAnimal { allowedTargets = 2; };
