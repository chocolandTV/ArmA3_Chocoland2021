...
switch (_lockState) do
{
	...
	case 1: // UNLOCK
	{
		...
		if (_totalDuration == 45)exitWith {["You cannot unlock this Object!", 5] call mf_notify_client;R3F_LOG_mutex_local_verrou = false;};
		_checks =
		{
			private ["_progress", "_object", "_failed", "_text"];
			_progress = _this select 0;
		...
		_success = [1, "AinvPknlMstpSlayWrflDnon_medic", _checks, [_object]] call a3w_actions_start;
